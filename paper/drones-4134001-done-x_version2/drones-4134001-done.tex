...
In this section, we briefly survey the most common open-source and/or freeware tools that are currently available for photogrammetric data processing, and describe where \textsc{drone2report} stands in this landscape. We provide a summary table in the Supplementary Material.
...
\supplementary{The Supplementary Table 1 on the characteristics of the main freely available software packages for the processing of image data in agriculture can be downloaded at: XXX}
