...
In this illustration, drone-captured barley-field images from the same experiment as in case study n. 1 were used. However, instead of using one single plot (one single barley variety) at one single timepoint, the images cover 20 plots (20 barley varieties) over 10 flights.
