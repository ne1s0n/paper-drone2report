...
In contrast to most of the above solutions, \textsc{drone2report} has been developed specifically to streamline the processing of orthorectified UAV-captured images for the calculation of vegetation indices and the reporting of relevant summary statistics.
It is designed to sit after the orthomosaic generation (e.g. from ODM/WebODM or commercial tools) and provides a configuration-driven, reproducible pipeline that takes in input one or more multiband images (being these RGB, multispectral, thermal images and DEM files). 
