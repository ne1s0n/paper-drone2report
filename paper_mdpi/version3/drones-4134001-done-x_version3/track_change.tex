...
%DIF DEL ../drones-4134001-done-x_version2/drones-4134001-done.tex   Tue Mar 24 12:22:30 2026
%DIF ADD drones-4134001-done.tex                                     Tue Mar 24 17:52:09 2026
...
First of all, there is no graphical interface (GUI), which may pose a barrier for users unfamiliar with command-line tools. This, however, was a design choice, since the tool was developed as part of a larger, server-based pipeline\DIFaddbegin \DIFadd{.
}

\DIFadd{Second, in the current implementation }\textsc{\DIFadd{drone2report}} \DIFadd{does not expose any radiometric calibration capability, which can be very important to compare vegetation indices across different flights}\DIFaddend .
